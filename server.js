...
<body><div class="wrap">
  ...
  <div class="kpi-strip"><div class="kpi-row">
    ...
    <div class="kpi-cell"><div class="kpi-val" style="color:#6ea8fe;">${Math.round(rec22/297)}x</div><div class="kpi-lbl">Est. report ROI</div></div>
  </div></div>
  ${bmHtml}
  ${chartSection}
  ${sectionsHtml}
